...
func NewController(
	...
	fooInformer informers.AppInformer) *Controller {
...
func (c *Controller) syncHandler(ctx context.Context, key string) error {
	...
	foo, err := c.foosLister.Apps(namespace).Get(name)
	if err != nil {
	...
	err = c.updateAppStatus(foo, deployment)
	if err != nil {
		return err
	}
...
func (c *Controller) updateAppStatus(foo *samplev1alpha1.App, deployment *appsv1.Deployment) error {
	...
	_, err := c.sampleclientset.appcontrollerV1alpha1().Apps(foo.Namespace).UpdateStatus(context.TODO(), fooCopy, metav1.UpdateOptions{})
	return err
}
...
func (c *Controller) handleObject(obj interface{}) {
	...
	if ownerRef := metav1.GetControllerOf(object); ownerRef != nil {
		...
		foo, err := c.foosLister.Apps(object.GetNamespace()).Get(ownerRef.Name)
		if err != nil {
